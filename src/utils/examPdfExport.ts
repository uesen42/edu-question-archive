      ...
      <div class="student-info">
        <div class="student-left">
          ...
          <div class="info-row">
            ...
            <div class="info-line">
              <span class="info-value">${exam.className || ''}</span>
            </div>
          </div>
        </div>
        <div class="student-right">
          ...
          <div class="info-row">
            ...
            <div class="info-line">
              <span class="info-value">${exam.schoolName}</span>
            </div>
          </div>
        </div>
      </div>
...
export async function exportExamToPDF(
  ...
  try {
    console.log('Sınav PDF export başlıyor...');
    
    const htmlContent = generateExamPDFHTML(exam, questions, categories, settings);
    
    const options = {
      margin: [10, 10, 10, 10],
      filename: `${sanitizeTurkishChars(exam.title.replace(/[^\w\d\s]/g, "_"))}_Sinavi.pdf`,
      image: { 
        type: "jpeg", 
        quality: 0.98 
      },
    ...
    console.log('Sınav PDF başarıyla oluşturuldu ve indirildi');
